...
public class VentanaOperador extends JFrame {
    public VentanaOperador(OperadorAereo operador) {
        setTitle("Operaciones del Aeropuerto");
        ...
        JLabel saludo = new JLabel("Bienvenido de vuelta \"" + operador.getNombre() + "\"");
        ...
        JLabel iconoUsuario = new JLabel("\uD83D\uDC64 \"" + operador.getNombre() + "\"");
        ...
        JLabel titulo = new JLabel("Bienvenido a la aplicacion para operar el aeropuerto");
